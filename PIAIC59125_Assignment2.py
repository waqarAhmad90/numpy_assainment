...
def function8():
    ...
    x = np.full(shape=10,fill_value=6,dtype='uint32').reshape(2,5)
...
def function12():
    ...
    ans = np.concatenate((repeat,tile),axis=0)
    return ans
...
def function14():
    ...
    ans = np.split(arr,[2,4,6,8],axis=0)
